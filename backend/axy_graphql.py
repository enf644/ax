...
class createDefaultUser(graphene.Mutation):
	class Arguments:
	...
	def mutate(self, info, **args):
		user = UserModel(name='Default', email='Email', username='Username')
		db_session.add(user)
		db_session.commit()
		ok = True
		return createDefaultUser(user=user, ok=ok)
...
class MyMutations(graphene.ObjectType):
	...
	create_default_user = createDefaultUser.Field()
